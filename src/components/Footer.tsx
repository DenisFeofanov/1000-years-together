...
export default function Footer() {
  ...
  return (
    <footer className="px-[15px] pb-[85px] flex flex-col items-center text-center text-grayDark text-[0.6875rem] font-normal leading-[1.5] md:text-[0.8125rem] md:px-0 md:p-0 md:bg-[#F5F5F5] md:pt-[30px] md:pb-[65px]">
      {currPathname === "/" && (
        <p className="hidden sm:block sm:px-[15px] sm:mx-auto sm:mb-[30px] sm:max-w-[40rem] sm:text-center sm:text-blackText sm:text-[1.125rem] sm:font-normal sm:leading-[1.5] lg:[1.125rem]">
          Спектакль стал итогом научно-театральной лаборатории{" "}
          <NoWrap>«1000 лет вместе»</NoWrap>, где через биографические интервью
          с людьми разного возраста, социального положения и опыта мы
          исследовали отношение к смерти. Премьера состоялась в 2019&nbsp;году в
          рамках <NoWrap>5-й Уральской</NoWrap> индустриальной биеннале
